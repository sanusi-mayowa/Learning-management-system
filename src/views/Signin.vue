              ...
              <div class="d-flex justify-center">
                <div>
                  <v-img
                    ...
                    class="pb-5 ml-2"
                  ></v-img>
                  <div class="text-label text-dark text-center pt-3">
                    Sign in Your Account
                  </div>
                </div>
              </div>
              <v-form class="mt-2 form px-5" @submit.prevent="submitForm">
                <div>
                ...
                ></v-checkbox>
                <span class="mb-2 text-link"
                  ><router-link
                    to="/forgotpassword"
                    class="textblack text-decoration-none"
                    >Forgot Password?</router-link
                  ></span
                >
                <v-btn block class="bg-btn" type="submit" flat>Sign In</v-btn>
              </v-form>
              <div class="px-5 account mt-5 text-link">
                Don't have an account?
                <span class="text-link"
                  ><router-link to="/signup" class="textblack"
                    >sign up</router-link
                  ></span
                >
              </div>
